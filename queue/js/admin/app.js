...
const routes = {
    ...
    scheduler: {
        label: "Планировщик",
        description: "Автоматическое закрытие смены по дням недели",
        group: "Система",
        icon: "scheduler",
        mount: mountScheduler
    },
    map: {
        label: "Карта",
...
const icons = {
    ...
    scheduler: '<rect x="3" y="5" width="18" height="16" rx="2"/><path d="M7 3v4M17 3v4M3 10h18M8 14h3v3H8Z"/>',
